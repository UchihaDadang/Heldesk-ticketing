...
const UserPage = () => {
    ...
    const features = [
      ...
      },
      {
        ...
        fields: ["Nama", "Email", "Nomor Telefon", "Informasi Objek Yang Hialng"]
      },
      {
        id: 3,
        title: "KDRT",
        description: "Form untuk menangani laporan kekeransan dalam rumah tangga",
        fields: ["Nama", "Nomor Telefon", "Alamat", "Nama Pelaku", "Keterangan"]
      },
      {
        id: 4,
        title: "Bulying",
        description: "Form untuk menangani laporan pembulian",
        fields: ["Nama", "Asal Sekolah", "Deskripsi"]
      },
      {
        id: 5,
        title: "Tindakan Mencurigakan",
        description: "Form untun menangani laporan tindakan mencurigakan",
        fields: ["Nama", "Nomor Telfon", "Alamat", "Deskripsi Tindakan Mencurigakan"]
      },
      {
        id: 6,
  ...
  return (
    <div className="d-flex flex-column" style={{ minHeight: "100vh" }}>
      <Navbar expand="lg" fixed="top" className="w-100">
        <Container>
          <Navbar.Brand href="#home">Helpdesk Polres Aceh Tamiang</Navbar.Brand>
      ...
      <main style={{ marginTop: "56px", paddingTop: "20px", paddingBottom: "20px" }}>
        <Container className="text-center my-4">
          <h1>Selamat Datang di sistem informasi Heldesk</h1>
          ...
          <Form>
            {selectedFeature?.fields.map((field, index) => (
              <Form.Group className="mb-3" key={index}>
                ...
                <Form.Control type="text" placeholder={`Masukkan ${field}`} />
              </Form.Group>
            ))}
          </Form>
        </Modal.Body>
