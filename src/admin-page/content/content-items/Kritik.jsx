    ...
    <Container className="mt-5 d-flex justify-content-center">
      <Card className="shadow-lg p-4 w-100" style={{ maxWidth: "900px" }}>
        <Card.Body>
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h2 className="text-center text-primary m-0">Daftar Kritik Pengguna</h2>
            {feedbacks.length > 0 && (
              <Button 
                variant="danger" 
                  ...
                  feedbacks.map((feedback, index) => (
                    <tr key={feedback.id || index}>
                      ...
                      <td className="text-start">
                        {feedback.kritik ? `${feedback.kritik.substring(0, 20)}...` : "_"}
                      </td>
                      <td>
                        <Button 
                          variant="info" 
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)}>
        <Modal.Header closeButton>
          <Modal.Title>Detail Kritik</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {selectedFeedback && (
            <>
              ...
              <p><strong>Kritik:</strong> {selectedFeedback.kritik}</p>
            </>
          )}
        </Modal.Body>
        <Modal.Footer>
