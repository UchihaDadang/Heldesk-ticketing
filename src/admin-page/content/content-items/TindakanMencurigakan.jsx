import { HeaderTindakanMencurigakan } from "../../../modal/ModalHeaders";
...
const TindakanMencurigakan = () => {
  const [data, setData] = useState([]);
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://localhost:3000/api/report/suspecious-activity");
    ...
    const handleDeleteAll = async () => {
        ...
        try {
            const reportType = "suspicious-activity";
...
export default TindakanMencurigakan