...
const [data, setData] = useState([]);
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://localhost:3000/api/report/bullying");
                                    ...
                                    {currentItems.length > 0 ? (
                                        currentItems.map((item) => (
                                            <tr key={item.id} className="text-center">
                                                ...
                                                <td>{item.asal_sekolah ? `${item.asal_sekolah.substring(0, 15)}...` : "-"}</td>
                            ...
                            <Modal.Body>
                                {selectedData ? (
                                    <div>
                                        ...
                                        <p><strong>Asal Sekolah:</strong> {selectedData.asal_sekolah || "-"}</p>
